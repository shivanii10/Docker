How to run a Java Program using Docker:
...
- create a java program, here Trial.java.
...
- view docker images: docker images 
                      ...
                      java-image    latest    af8860dcd6c0   27 seconds ago   470MB
- To run the docker image: docker run <img-name>,
                           docker run java-image
                           Output: Trial! (Java fil will be executed)
